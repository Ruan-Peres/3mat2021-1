// A rigor, a função abaixo nãseria necessária, pois, usando
...
// que é um modo aleatório "abreviado" de escrever uma função em JS
...
// 5) Uma arrow function anônima. Portanto, caso se deseje
// chama-lá posteriormente, é necessário atribuí-la a uma variável.
const quadrado2 = x => x * x
console.log(quadrado2(9))

// Função com mais de um parâmetro
function potencua(b, e) { // b = base, e = expoente
    return b ** e
}
console.log(potencia(2, 10))

// Aroow function equivalente 
// Quando temos mais de um parâmetro
...
// Os parâmetros vazios (obrigatórios) marcam o lugar de parâmetros
...
const somaVet2 = vet => {
    let soma = 0
    for(let n of vet) soma += // soma = soma + n
    return soma
}
